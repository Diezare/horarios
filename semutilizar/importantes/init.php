...
///////////////////////////////////////////////////////////
// 5) PROTEÇÃO CSRF GLOBAL AUTOMÁTICA - SIMPLES
///////////////////////////////////////////////////////////
...
// Valida automaticamente em TODOS os POST (exceto login)
...
// Valida CSRF automaticamente
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $deveValidarCSRF) {
    // Tenta pegar o token de 3 formas:
    ...
    if (empty($csrf_token) || !hash_equals($_SESSION['csrf_token'], $csrf_token)) {
        ...
        logSecurityEvent("Tentativa de CSRF bloqueada - Token inválido ou ausente");
        die("Erro de segurança: Token inválido! Recarregue a página e tente novamente.");
    }
    
    // Gera novo token após cada POST válido (opcional)
    $_SESSION['csrf_token'] = bin2hex(random_bytes(32));
}

// Função helper para forms (opcional - se quiser ainda usar nos forms específicos)
