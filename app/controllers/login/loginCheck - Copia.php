...
// >>> ADICIONAR ESTA VERIFICAÇÃO DE CSRF AQUI <<<
if (!isset($_POST['csrf_token']) || $_POST['csrf_token'] !== $_SESSION['csrf_token']) {
    // Para ataques CSRF, é melhor apenas rejeitar o pedido sem revelar detalhes
    http_response_code(403); // Proibido
    registrarLogAtividadeArquivo('csrf_token_invalido_ou_ausente');
    echo json_encode(['status' => 'error', 'message' => 'Token de segurança inválido.']);
    exit;
}
// FIM DA VERIFICAÇÃO DE CSRF
