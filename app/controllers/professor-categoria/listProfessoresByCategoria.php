<?php
// app/controllers/professor-categoria/listProfessoresByCategoria.php
...
if ($id_categoria <= 0) {
    echo json_encode([
        'status'  => 'error',
        'message' => 'Parâmetro id_categoria inválido ou ausente.'
    ]);
    exit;
}

try {
    // professor_categoria faz vínculo (id_professor, id_categoria)
    // professor para pegar nome_completo ou nome_exibicao
    $sql = "
